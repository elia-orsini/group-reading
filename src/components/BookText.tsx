      ...
      <div className="rounded-xl bg-[var(--background)] p-6 shadow-sm sm:p-8">
        ...
        <div className="mb-6">
          ...
          <select
            ...
            className="border-[var(--foreground)]/40 w-full rounded-lg border bg-[var(--background)] p-2 opacity-80 hover:opacity-60 focus:border-[var(--foreground)]/60 focus:outline-none focus:ring-2 focus:ring-[var(--foreground)]/60"
          >
        ...
        <div className="mt-8 space-y-6">
          <h2 className="border-b border-gray-100 pb-4 text-2xl font-bold capitalize text-[var(--foreground)]">
            {currentChapter?.title || todayChapter.title}
          </h2>

          {(currentChapter?.content || todayChapter.content) && (
            <p className="prose prose-lg mt-4 text-[var(--foreground)] opacity-80">
          ...
          <div className="prose prose-lg max-w-none text-[var(--foreground)] opacity-80">
